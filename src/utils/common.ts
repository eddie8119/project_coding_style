 ...
 *
 * @param {number|string} ts - The timestamp to convert. Can be a number or a string representing the number of milliseconds since the Unix Epoch.
 * @returns {string} The formatted date string in the format "YYYY/MM/DD HH:MM:SS".
 */
export function datetimeToString(ts) {
...
/**
 * Deletes a property from an object and returns the value of the deleted property.
 *
 * @param {Object} obj - The object from which the property will be deleted.
 * @param {string} key - The key of the property to delete.
 * @returns {*} The value of the deleted property.
 */
export function deleteAndGet(obj, key) {
  const value = obj[key];
  delete obj[key];
  return value;
}
 ...
 */
export function getDifferences<T>(originalObj: T, updatedObj: Partial<T>): Partial<T> {
